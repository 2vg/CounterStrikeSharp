...
namespace CounterStrikeSharp.API.Core
{
    public class NativeAPI
    {
        ...
        public static IntPtr CreateConnectedPlayersIterator()
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
                ScriptContext.GlobalScriptContext.SetIdentifier(0xA8EE3343);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
                return (IntPtr)ScriptContext.GlobalScriptContext.GetResult(typeof(IntPtr));
            }
        ...
        public static bool IteratorHasNext(IntPtr iterator)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
                ScriptContext.GlobalScriptContext.Push(iterator);
                ScriptContext.GlobalScriptContext.SetIdentifier(0x4FB3BCDA);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
                return (bool)ScriptContext.GlobalScriptContext.GetResult(typeof(bool));
            }
        ...
        public static int IteratorGetCurrentSlot(IntPtr iterator)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
                ScriptContext.GlobalScriptContext.Push(iterator);
                ScriptContext.GlobalScriptContext.SetIdentifier(0xB0B67D03);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
                return (int)ScriptContext.GlobalScriptContext.GetResult(typeof(int));
            }
        ...
        public static void IteratorMoveNext(IntPtr iterator)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
                ScriptContext.GlobalScriptContext.Push(iterator);
                ScriptContext.GlobalScriptContext.SetIdentifier(0xA7F132B1);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
            }
        }

        public static void DestroyIterator(IntPtr iterator)
        {
            lock (ScriptContext.GlobalScriptContext.Lock)
            {
                ScriptContext.GlobalScriptContext.Reset();
                ScriptContext.GlobalScriptContext.Push(iterator);
                ScriptContext.GlobalScriptContext.SetIdentifier(0x57BE1C1A);
                ScriptContext.GlobalScriptContext.Invoke();
                ScriptContext.GlobalScriptContext.CheckErrors();
            }
        }
